...
const MyCarousel = () =>(
    ...
    >
        <Box w={'full'} h={'full'}>
            ...
            <Heading bgColor={"blackAlpha.400"} color={"white"} w={'fit-content'}{...headingOptions}>see the future through us</Heading>

        </Box>

        <Box w={'full'} h={'full'}>
            <Image src={img2} h="full" w={'full'} objectFit={'cover'} />
            <Heading bgColor={"whiteAlpha.400"} color={"black"} {...headingOptions}>Future is Gaming</Heading>
        </Box>

        <Box w={'full'} h={'full'}>
            <Image src={img3} h="full" w={'full'} objectFit={'cover'} />
            <Heading bgColor={"whiteAlpha.400"} color={"black"} {...headingOptions}>Gaming on console</Heading>
        </Box>

        <Box w={'full'} h={'full'}>
            <Image src={img4} h="full" w={'full'} objectFit={'cover'} />
            <Heading bgColor={"whiteAlpha.400"} color={"black"} {...headingOptions}>Night life is cool</Heading>
        </Box>
